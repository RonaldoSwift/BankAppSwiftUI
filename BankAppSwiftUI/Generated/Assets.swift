...
internal enum Asset {
  internal enum Colores {
    ...
    internal static let black900 = ColorAsset(name: "black900")
  ...
  internal enum Imagenes {
    internal static let ahorroDinero = ImageAsset(name: "AhorroDinero")
    internal static let ahorroNegocios = ImageAsset(name: "AhorroNegocios")
    internal static let ahorroPlazoFijo = ImageAsset(name: "AhorroPlazoFijo")
    internal static let arrowBack = ImageAsset(name: "ArrowBack")
    internal static let bankLogo = ImageAsset(name: "BankLogo")
    internal static let calendar = ImageAsset(name: "Calendar")
    internal static let compartir = ImageAsset(name: "Compartir")
    ...
    internal static let qulqi = ImageAsset(name: "Qulqi")
    internal static let rightArrow = ImageAsset(name: "RightArrow")
    internal static let seguro = ImageAsset(name: "Seguro")
    internal static let seguroFlex = ImageAsset(name: "SeguroFlex")
    internal static let seguroSoat = ImageAsset(name: "SeguroSoat")
    internal static let seguroVenta = ImageAsset(name: "SeguroVenta")
    internal static let seguroVidaDevolucion = ImageAsset(name: "SeguroVidaDevolucion")
    internal static let sugerencia = ImageAsset(name: "Sugerencia")
    internal static let threeDots = ImageAsset(name: "ThreeDots")
    internal static let vendedor = ImageAsset(name: "Vendedor")
    internal static let venderMas = ImageAsset(name: "VenderMas")
    internal static let yape = ImageAsset(name: "Yape")
    internal static let yevo = ImageAsset(name: "Yevo")
